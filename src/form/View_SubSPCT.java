...
public final class View_SubSPCT extends javax.swing.JDialog {
    ...
    public View_SubSPCT() {
        ...
        SanPhamChiTiet sanPhamChiTiet = spcts.getByQR(View_QR.maQR).get(0);
        setModelSPCT(sanPhamChiTiet);
    }
    


    void setModelSPCT(SanPhamChiTiet o) {
        ...
        jTextArea1.setText(sp.getTenSP());
        jTextField1.setText(df.format(o.getGia()));
        jTextField4.setText(o.getSoLuong().toString());
        jTextField2.setText(tt1.getTenThuocTinh());
        jTextField3.setText(tt2.getTenThuocTinh());
        jTextField6.setText(o.getMaSPCT());
        jTextField5.setText("1");
        if (o.getAnh() != null) {
            jLabel1.setToolTipText(o.getAnh());
            jLabel1.setIcon(ImageHelper.readImg(o.getAnh()));
        } else {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Áo Hoodie Zip EMPTI Tag Su 01 - Áo Khoác Nỉ Dây Kéo Nhiều");
        jTextArea1.setCursor(new java.awt.Cursor(java.awt.Cursor.CROSSHAIR_CURSOR));
        jScrollPane1.setViewportView(jTextArea1);

        jLabel2.setText("180k");
        ...
        jLabel8.setText("Nhập số lượng mua: ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int value = Integer.valueOf(jTextField5.getText());
            ...
            if (value < 0) {
                ...
                if (hoaDonChiTiet != null) {
                    hdcts.update(HoaDonChiTiet.builder()
                            ...
                            .soLuong(value + hoaDonChiTiet.getSoLuong())
                ...
                Notifications.getInstance().show(Notifications.Type.SUCCESS, Notifications.Location.TOP_CENTER, "Thêm vào giỏ hàng thành công");
                dispose();
            }
        }
